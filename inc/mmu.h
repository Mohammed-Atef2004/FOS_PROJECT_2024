...
#define PERM_PRESENT	0x001	// Present 1
#define PERM_WRITEABLE		0x002	// Writeable2
#define PERM_USER		0x004	// User 3
#define PTE_PWT		0x008	// Write-Through 4
#define PTE_PCD		0x010	// Cache-Disable 5
#define PERM_USED		0x020	// Accessed 6
#define PERM_MODIFIED		0x040	// Dirty 7
#define PTE_PS		0x080	// Page Size 8
#define PTE_MBZ		0x180	// Bits must be zero
#define PERM_BUFFERED 	0x200 //Page it buffered 10
#define PERM_MARKED 	0x400 //Page it marked 11
#define PERM_ALLOC_END	 0x800 //last Page in every allocation 12
